    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                String address = cursor.getString(cursor.getColumnIndex(DBRepository.COLUMN_ADDRESS));
                int yearConclusion = cursor.getInt(cursor.getColumnIndex(DBRepository.COLUMN_YEAR_CONCLUSION));
                String tariffName = cursor.getString(cursor.getColumnIndex(DBRepository.COLUMN_TARIFF_NAME));
                String tariffCost = cursor.getString(cursor.getColumnIndex(DBRepository.COLUMN_TARIFF_COST));
                ...
                builder.append("ID: ").append(id).append("\n")
                        ...
                        .append("Год договора: ").append(yearConclusion).append("\n")
                        .append("Тариф: ").append(tariffName).append("\n")
                        .append("Стоимость: ").append(tariffCost).append("\n\n");
