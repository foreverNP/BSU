    ...
    , ui(new Ui::MainWindow)
{
    ...
    g -> addWidget(ui -> TransformationMatrixLabel, 0, 8, 1, 2);
    g -> addWidget(ui -> TransformationMatrix,     1, 8, 1, 2);
    ...
    setWindowTitle("3D ultra cinema");
    area -> SetFigurePoints(
    {Point(1, 1, 1), Point(4, 1, 1), Point(4, 2, 1), Point(2, 2, 1), Point(2, 3, 1), Point(4, 3, 1), Point(4, 4, 1),Point(1, 4, 1), Point(1, 1, 1),
     Point(1, 1, 2), Point(4, 1, 2), Point(4, 2, 2), Point(2, 2, 2), Point(2, 3, 2), Point(4, 3, 2), Point(4, 4, 2),Point(1, 4, 2), Point(1, 1, 2)});
}
